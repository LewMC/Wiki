...
| Added   | [Extended teleport toggles](https://github.com/LewMC/Essence/issues/145), PlaceholderAPI support alongside new team-based placeholders.                                                                                                                                                                                                                                                           |
|---------|---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| Removed | Nothing was removed in this update.                                                                                                                                                                                                                                                                                                                                                               |
| Changed | Placeholders have replaced Message Tags and their values have changed in this update, whilst your old tags will continue to work please consider [updating them to the new values](ES-Placeholders.md) as we will remove the old values in a future update. Essence will automatically update your join/leave messages, you'll have to update your MOTDs and rules yourself if you use them here. |
