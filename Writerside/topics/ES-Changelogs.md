...
| Added   | Added new /es restore command that restores Essence's files. User IP addresses now appear in /info (requires extra permission node and can be toggled in config).                                                                |
|---------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
