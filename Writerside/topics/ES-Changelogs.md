...
| Added   | Added new /es restore command that restores Essence's files. User IP addresses now appear in /info (requires extra permission node and can be toggled in config). Teleport wait time is now toggleable. Added support for [placeholders](ES-Placeholders.md) in language files. Added new [Environment module](ES-Time-and-Weather.md). |
|---------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
